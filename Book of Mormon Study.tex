...
\item The Likening section was not originally included until a church lesson reintroduced the idea found in 1 Nephi 19:23 (see \Cref{1Nephi19:23}) which invites all of us to liken the scriptures to our own lives  While this section could be (and elements of it often are) included in the Comments section, I felt it both necessary and important to specifically address this in its own section.
\item The Additional References section has references to other scriptures (hyperlinked to the related section within the document as appropriate), as well as various other sources I have come across in my studies (notably scriptures.byu.edu, the \emph{LDS Citation Index}.  Note that references to general conferences before 1971 will not be linked, but the documents exist in the Citation Index).  Note that not all of the references are endorsed by the Church!  I have made an effort in this study to broaden my own understanding, and part of this that I have felt important for me to understand are the concerns and complaints of those who are opposed to the church.  Thus, while many of the references are supportive of church doctrine, others may have less-than-favorable views of church doctrine.  In those cases, I have made my own effort to explain why \emph{I} feel that those opinions are wrong.  I do advise that anyone seeking to know the truth seek the One who \emph{is} Truth.  Mankind is fallible, and will often miss the mark.  This being said, I advise those who feel they may be struggling with their testimony to first study on their own before indulging in the following study.  Ask the Lord for a testimony of His work, and seek to know for yourself that The Church of Jesus Christ of Latter-day Saints is His kingdom once again established on the earth.  I have found that even in this study I had to reaffirm my own testimony again and again, and each time I asked, I received (as promised in Doctrine and Covenants in numerous places, see for example D\&C 4:7).
\end{itemize}
\item At the end of each Chapter is another section entitled ``General Comments."  This is an effort to combine the knowledge and insights gained in the study of the previous verses/paragraphs.  Again, this is not exhaustive, but this is meant to try and glean additional principles from the text.
\end{itemize}

It is my hope that any and all who might read this may have their own testimony strengthened that Jesus is the Christ.  My own testimony has been strengthened as I have come to know His works through this study.  Through that knowledge, I have also come to know with even more surety than I had before that Joseph Smith was God's chosen prophet to restore His church to the earth, and that Joseph Smith was inspired to translate the Book of Mormon from plates having the appearance of gold.  I can testify with certainty that God lives.  There is simply too much evidence to ignore.  I invite any, and all individuals who seek for more from their lives to ``come and see" what the Book of Mormon has to offer.  There is much in the way of spiritual nourishment to be found!
...
\begin{itemize}
\item \index{Gathering}Gathering
...
\begin{itemize}
\item Mormon 8:17 (\Cref{Mormon8:17})
...
\item M. Russell Ballard, 1995 October General Conference, \href{https://www.lds.org/general-conference/1995/10/firm-as-the-pillars-of-heaven?lang=eng}{\emph{``Firm as the Pillars of Heaven"}}
\item Ezra Taft Benson, 1987 April General Conference, \href{https://www.lds.org/general-conference/1987/04/the-book-of-mormon-and-the-doctrine-and-covenants?lang=eng}{\emph{The Book of Mormon and the Doctrine and Covenants}}
\item Mark E. Petersen, 1978 April General Conference, \emph{``Evidence of Things Not Seen"}
\item LeGrand Richards, 1967 April General Conference, \emph{The Book of Mormon}
\item S. Dilworth Young, 1965 April General Conference, \emph{The Book of Mormon: Its Own Silent Witness}
\item William J. Critchlow Jr., 1960 April General Conference, \emph{A Divine Key to Knowledge}
\item LeGrand Richards, 1959 April General Conference, \emph{Ours -- The Greatest Message}
...
\item Mormon 9:9 (\Cref{Mormon9:9})
\end{itemize}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\item 1 Nephi 3:7 (\Cref{1Nephi3:7})
\end{itemize}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
Two important books came about from the efforts of Joseph Smith - the most important is The Book of Mormon, and the other book is the History of the Church.  There is much contained in these two histories that merit further study, but the primary focus should be on the Book of Mormon (see \Cref{intro:6th}).

\subsubsection{Additional References\label{js:referencesFinal}}
\begin{itemize}
\item Introduction to the Book of Mormon, paragraph 6 (\Cref{intro:6th})
\end{itemize}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\item D\&C 121:34
\item James B. Martino, October 2015 General Conference, \href{https://www.lds.org/general-conference/2015/10/turn-to-him-and-answers-will-come?lang=eng}{\emph{Turn to Him and Answers Will Come}}
\item Jay E. Jensen, October 2010 General Conference, \href{https://www.lds.org/general-conference/2010/10/the-holy-ghost-and-revelation?lang=eng}{\emph{The Holy Ghost and Revelation}}
\item L. Tom Perry, April 2010 General Conference, \href{https://www.lds.org/general-conference/2010/04/mothers-teaching-children-in-the-home?lang=eng}{\emph{Mothers Teaching Children in the Home}}
\item Yoon Hwan Choi, October 2009 General Conference, \href{https://www.lds.org/general-conference/2009/10/i-love-loud-boys?lang=eng}{\emph{I Love Loud Boys}}
\item Mary N. Cook, October 2007 General Conference, \href{https://www.lds.org/general-conference/2007/10/strengthen-home-and-family?lang=eng}{\emph{Strengthen Home and Family}}
\item Claudio R. M. Costa, October 2007 General Conference, \href{https://www.lds.org/general-conference/2007/10/don-t-leave-for-tomorrow-what-you-can-do-today?lang=eng}{\emph{Don't Leave for Tomorrow What You Can Do Today}}
\item Vicki F. Matsumori, April 2007 General Conference, \href{https://www.lds.org/general-conference/2007/04/a-lesson-from-the-book-of-mormon?lang=eng}{\emph{A Lesson from the Book of Mormon}}
\item Donald L. Staheli, October 2004 General Conference, \href{https://www.lds.org/general-conference/2004/10/securing-our-testimonies?lang=eng}{\emph{Securing Our Testimonies}}
\item Julie B. Beck, April 2004 General Conference, \href{https://www.lds.org/general-conference/2004/04/a-mother-heart?lang=eng}{\emph{A ``Mother Heart"}}
\item Darwin B. Christensen, April 2001 General Conference, \href{https://www.lds.org/general-conference/2001/04/david-a-future-missionary?lang=eng}{\emph{David, a Future Missionary}}
\item Loren C. Dunn, April 2000 General Conference, \href{https://www.lds.org/general-conference/2000/04/because-my-father-sent-me?lang=eng}{\emph{``Because My Father Sent Me"}}
\item Neal A. Maxwell, October 1999 General Conference, \href{https://www.lds.org/general-conference/1999/10/lessons-from-laman-and-lemuel?lang=eng}{\emph{Lessons from Laman and Lemuel}}
\item Eran A. Call, October 1997 General Conference, \href{https://www.lds.org/general-conference/1997/10/the-home-a-refuge-and-sanctuary?lang=eng}{\emph{The Home: A Refuge and Sanctuary}}
\item Jerald L. Taylor, April 1997 General Conference, \href{https://www.lds.org/general-conference/1997/04/gratitude?lang=eng}{\emph{Gratitude}}
\item Neal A. Maxwell, April 1996 General Conference, \href{https://www.lds.org/general-conference/1996/04/becometh-as-a-child?lang=eng}{\emph{``Becometh As a Child"}}
\item Anne G. Wirthlin, October 1995 General Conference, \href{https://www.lds.org/general-conference/1995/10/touch-the-hearts-of-the-children?lang=eng}{\emph{Touch the Hearts of the Children}}
\item L. Tom Perry, 1994 April General Conference, \href{https://www.lds.org/general-conference/1994/04/therefore-i-was-taught?lang=eng}{\emph{``Therefore I Was Taught"}}
\item Dallas N. Archibald, 1992 October General Conference, \href{https://www.lds.org/general-conference/1992/10/born-of-goodly-parents?lang=eng}{\emph{``Born of Goodly Parents"}}
\item M. Russell Ballard, 1991 October General Conference, \href{https://www.lds.org/general-conference/1991/10/the-family-of-the-prophet-joseph-smith?lang=eng}{\emph{The Family of the Prophet Joseph Smith}}
\item Graham W. Doxey, 1991 October General Conference, \href{https://www.lds.org/general-conference/1991/10/the-voice-is-still-small?lang=eng}{\emph{The Voice is Still Small}}
\item Ezra Taft Benson, 1985 October General Conference, \href{https://www.lds.org/general-conference/1985/10/worthy-fathers-worthy-sons?lang=eng}{\emph{Worthy Fathers, Worthy Sons}}
\item L. Tom Perry, 1985 April General Conference, \href{https://www.lds.org/general-conference/1985/04/born-of-goodly-parents?lang=eng}{\emph{``Born of Goodly Parents"}}
\item L. Tom Perry, 1983 April General Conference, \href{https://www.lds.org/general-conference/1983/04/train-up-a-child?lang=eng}{\emph{Train Up a Child}}
\item A. Theodore Tuttle, 1979 October General Conference, \href{https://www.lds.org/general-conference/1979/10/therefore-i-was-taught?lang=eng}{\emph{Therefore I Was Taught}}
\item A. Theodore Tuttle, 1973 October General Conference \href{https://www.lds.org/general-conference/1973/10/the-role-of-fathers?lang=eng}{\emph{The Role of Fathers}}
\item S. Dilworth Young, 1972 October General Conference, \href{https://www.lds.org/general-conference/1972/10/having-been-born-of-goodly-parents?lang=eng}{\emph{``Having Been Born of Goodly Parents"}}
\item David B. Haight, 1970 October General Conference, \emph{Times Which Are Too Full}
\item Spencer W. Kimball, 1969 October General Conference, \emph{Spiritual Reservoirs}
\item Henry D. Taylor, 1968 April General Conference, \emph{``Men Are That They Might Have Joy"}
\item Don Lind, 1967 April General Conference, \emph{Mormon Astronaut}
\item Spencer W. Kimball, 1965 April General Conference, \emph{Home Training -- The Cure for Evil}
\item Robert L. Simpson, 1964 April General Conference, \emph{A Memo to Dads}
\item Thomas S. Monson, 1963 October General Conference, \emph{``I Stand at the Door and Knock"}
\item Theodore M. Burton, 1960 October General Conference, \emph{Gratitude}
\item Hugh B. Brown, 1954 April General Conference, \emph{Our Debt to the Past}
\item ElRay L. Christiansen, 1952 October General Conference, \emph{``Be Ye Doers of the Word"}
\item George Albert Smith, 1945 October General Conference, \emph{Closing Address}
\end{itemize}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\subsection{Additional References\label{1Nephi1:3:references}}
\begin{itemize}
...
Do the things that I know come from God cause me to quake and tremble?  There are many prophecies about the last days (in which we live), and many of them are not comforting.  However, perhaps I can find comfort in the fact that God will not destroy me \emph{if I repent and turn to him with my whole heart}.  Taking another approach to this verse, do I realize how insignificant I am compared to God?  Jacob points out that God could smite an individual with just the blink of an eye (see \Cref{Jacob2:15}). Insignificance notwithstanding, to God, we are \emph{everything}.  These realizations alone could be enough to cause us to quake and tremble, but rather with an overwhelming feeling of love and support.
